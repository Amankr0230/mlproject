...
function FlightPricePredictor() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-emerald-500 to-emerald-900 flex flex-col items-center py-10">
      ...
      <form
        ...
        className="bg-[#66cdaa] shadow-md rounded-lg p-8 w-full max-w-lg space-y-6"
      >
        {/* Airline Field */}
